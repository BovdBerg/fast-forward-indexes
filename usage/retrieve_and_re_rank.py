...
def main(args: argparse.Namespace) -> None:
    ...
    # TODO: include rm3 in sys_avg. Verify that query 'what is theraderm used for' has >10 n_docs in FFScore.transform ranking. After, remove n_embs_per_q logic and loop in AvgEmbQueryEstimator.
